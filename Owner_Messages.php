    ...
    <div class="container">
        ...
        <div class="messages-list">
            ...
            <div class="message-item">
                ...
                <div class="message-content">
                    <div class="message-header">
                        <span class="owner-name">Tenant 1</span>
                        <span class="timestamp">1:45 pm</span>
                    </div>
                    <div class="message-preview"><strong>Hi, is this still available? I would li...</strong></div>
                </div>
            </div>
            ...
            <div class="message-item">
                ...
                <div class="message-content">
                    <div class="message-header">
                        <span class="owner-name">tenant 2</span>
            ...
            <div class="message-item">
                ...
                <div class="message-content">
                    <div class="message-header">
                        <span class="owner-name">Tenant 3</span>
                        <span class="timestamp">10:16 am</span>
                    </div>
                    <div class="message-preview">You: Yes! It's still available for booking.</div>
                </div>
            </div>
            ...
            <div class="message-item">
                ...
                <div class="message-content">
                    <div class="message-header">
                        <span class="owner-name">Tenant 4</span>
